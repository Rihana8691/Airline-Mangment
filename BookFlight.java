    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == fetchButton) {
            ...
            try {
                ...
                String query = "select * from passenger where passport_number = '"+passnum+"'";
            ...
            try {
                ...
                String query = "insert into reservation values('"+passnum+"', 'TIC-"+random.nextInt(10000)+"', '"+name+"', '"+nationality+"', '"+flightname+"', '"+flightcode+"', '"+src+"', '"+des+"', '"+ddate+"')";
